    ...
    #opcion 3
        ...
        try: 
            ...
            if cantidad_a_devolver <= 0:
                ...
                print("Error: Supera la capacidad maxima d bicicletas")
            else:
                bicis_disponibles += cantidad_a_devolver
                viajes_activos -= cantidad_a_devolver
                print(f"Devolucion exitosa ha regresado {cantidad_a_devolver} bicis")
        except ValueError:
            print("Error: debe ingresar un numero entero valido")
    #opcion 4 
    elif opcion == 4:
        print(f"\n--- [HISTORIAL] la cantidad de viajes activos es: {viajes_activos}")
    #opcion 5
    elif == 5:
